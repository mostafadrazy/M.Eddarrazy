                    ...
                    <div className="lg:col-span-5">
                        <div className="sticky top-32">
                             ...
                             <div className="flex justify-between items-end border-b border-white/10 pb-4 mb-8">
                                 ...
                                 <span className="font-sans text-white text-sm">Motion & Graphic Design</span>
                             </div>

                             <a 
                                href="#" 
                                className="group w-full bg-white text-black py-4 rounded-lg font-sans font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-3 hover:bg-accent-red hover:text-white transition-all duration-300"
                             >
                            ...
                            <div className="relative border-l border-white/10 ml-1.5 space-y-12 pl-8 md:pl-12">
                                {EXPERIENCE.map((item, index) => (
                                    <div key={index} className="relative group">
                                        <div className="absolute -left-[37px] md:-left-[53px] top-1.5 w-3 h-3 bg-black border border-white/40 rounded-full group-hover:bg-accent-red group-hover:border-accent-red transition-colors"></div>
                                        <span className="font-mono text-xs text-accent-red mb-2 block">{item.period}</span>
            ...
            <div className="container mx-auto px-6 md:px-12 mt-32 border-t border-white/10 pt-20 animate-on-scroll">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    <div className="flex flex-col gap-4">
                        <span className="font-mono text-xs text-accent-red">01/</span>
                    ...
                    <div className="flex flex-col gap-4">
                        <span className="font-mono text-xs text-accent-red">02/</span>
                    ...
                    <div className="flex flex-col gap-4">
                        <span className="font-mono text-xs text-accent-red">03/</span>
