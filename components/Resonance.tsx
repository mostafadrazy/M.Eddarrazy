    ...
    <section className="bg-cinema-black/50 backdrop-blur-xl py-20 md:py-32 relative z-10 border-t border-white/5 overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 bg-zinc-950/60 border border-white/10 p-8 rounded-3xl flex flex-col gap-8 backdrop-blur-md animate-on-scroll">
            ...
            <button 
              ...
              className={`w-full py-4 rounded-xl font-mono text-xs font-bold uppercase tracking-widest flex items-center justify-center gap-3 transition-all duration-300 ${
                isPlaying 
          ...
          <div className="lg:col-span-7 bg-zinc-950/45 border border-white/10 p-8 rounded-3xl h-[330px] flex flex-col justify-between items-center relative overflow-hidden backdrop-blur-md animate-on-scroll delay-150">
            ...
            <div className="w-full flex justify-between items-center relative z-10 border-b border-white/5 pb-4">
            ...
            <div className="flex items-end justify-center w-full h-40 gap-[3px] py-2 relative z-10">
            ...
            <div className="w-full flex justify-between font-mono text-[8px] text-white/30 relative z-10 pt-4 border-t border-white/5">
